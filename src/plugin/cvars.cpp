...
static ConVar sl_version_major("sl_version_major", STR(SOURCELUA_VERSION_MAJOR),
    FCVAR_NONE, SOURCELUA_NAME " Major Version");
static ConVar sl_version_minor("sl_version_minor", STR(SOURCELUA_VERSION_MINOR),
    FCVAR_NONE, SOURCELUA_NAME " Minor Version");
static ConVar sl_version_patch("sl_version_patch", STR(SOURCELUA_VERSION_PATCH),
